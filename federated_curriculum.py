...
# model path
PATH = './models/fed-cl/'+str(params.noise)+'/'+str(params.nsteps)+'-'+str(params.pace)+'/torch-seed-' + str(params.torch_seed)
print(PATH)
...
optimizer0 = optim.Adam([{'params': local_model0.parameters()}], lr=params.learning_rate)
optimizer1 = optim.Adam([{'params': local_model1.parameters()}], lr=params.learning_rate)
optimizer2 = optim.Adam([{'params': local_model2.parameters()}], lr=params.learning_rate)
...
train_loaders = [train_loader0, train_loader1, train_loader2]
